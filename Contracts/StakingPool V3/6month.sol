...
contract month6 is Initializable{
    ...
    function updatePoolInfo() public{
        ...
        WithdrawalFee = MainPool.getWIthdrawalFees();
        MimimumStake = MainPool.getMinimumStake6();
    ...
    function stake(uint amount) external{
        ...
        require(amount >= MainPool.getMinimumStake6());
        ...
        amount -= Fees;
            ...
            claimNumber = 180 days / claim_time;
            ...
            Duration[msg.sender] += 180 days;

        emit Staked(msg.sender, amount, Fees, 180 days);
