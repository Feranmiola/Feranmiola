...
contract month3 is Initializable{
    ...
    function updatePoolInfo() public{
        ...
        WithdrawalFee = MainPool.getWIthdrawalFees();
        MimimumStake = MainPool.getMinimumStake3();
    ...
    function stake(uint amount) external{
        ...
        require(amount >= MainPool.getMinimumStake3());
        ...
        amount -= Fees;
            ...
            claimNumber = 90 days / claim_time;
            ...
            Duration[msg.sender] += 90 days;

        emit Staked(msg.sender, amount, Fees, 90 days);
